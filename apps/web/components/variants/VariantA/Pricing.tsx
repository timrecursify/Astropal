...
export default function VariantAPricing() {
  const plans = [
    {
      name: 'Free',
      price: '$0',
  ...
  return (
    <div className="space-y-3">
      <div className="text-center mb-6">
        <h3 className="text-lg font-semibold text-white mb-2">Newsletter Plans</h3>
        <p className="text-sm text-gray-400">AI-powered astrology delivered to your inbox</p>
      </div>

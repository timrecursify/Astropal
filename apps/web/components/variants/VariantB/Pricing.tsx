...
import { Check, Mail, Heart, Crown } from 'lucide-react';

export default function VariantBPricing() {
  const plans = [
    {
      name: 'Free',
      price: '$0',
      tagline: 'Relationship Pulse',
      icon: Mail,
      emailCount: '1 email/day',
      features: [
        'Daily compatibility pulse (6 AM)',
        'Basic relationship timing',
        'Friend vibe insights',
        'Communication mood alerts',
        'Shareable love quotes',
        'Weekly relationship preview',
        'Monthly romance overview',
    ...
    },
    {
      ...
      price: '$7.99',
      period: '/mo',
      tagline: 'Relationship Coach',
      icon: Heart,
      popular: true,
      emailCount: '2 emails/day',
      features: [
        'Morning relationship guide (6 AM)',
        'Evening connection tips (7 PM)',
        'Full compatibility analysis',
        'Dating & friendship timing',
    ...
    },
    {
      ...
      price: '$14.99',
      period: '/mo',
      tagline: 'Relationship Authority',
      icon: Crown,
      emailCount: '3 emails/day',
      features: [
        'Morning relationship strategy (6 AM)',
        'Midday social intel (12 PM)',
        'Evening connection guide (7 PM)',
        'Real-time compatibility alerts',
        'Family dynamics analysis',
        'Workplace relationship guide',
        'Long-term partnership insights',
        'Breakup recovery timing',
        'Marriage compatibility deep-dive',
        'Group dynamics analysis',
        'Dating market insights',
        'Priority relationship support'
      ],
      color: 'purple',
    ...
    switch (color) {
      case 'purple':
        return {
          ...
          button: 'border border-purple-500/50 text-purple-400 hover:bg-purple-500/10'
        };
      default:
        return {
  ...
  return (
    <div className="space-y-3">
      <div className="text-center mb-6">
        <h3 className="text-lg font-semibold text-white mb-2">Relationship Newsletter Plans</h3>
        <p className="text-sm text-gray-400">Daily relationship intel delivered to your inbox</p>
      </div>
      ...
      {plans.map((plan, index) => {
        ...
        return (
          <motion.div
            ...
            className={`relative p-4 rounded-xl border backdrop-blur-sm ${colors.border} ${colors.bg} ${plan.popular ? 'ring-1 ring-pink-400/30' : ''}`}
          >
            {plan.popular && (
